...
echo "<p>Mengupdate password admin...</p>";
echo "<pre>";
...
$query = "UPDATE users SET password = '" . mysqli_real_escape_string($conn, $newHash) . "' WHERE email = 'admin@gmail.com'";
...
if (mysqli_query($conn, $query)) {
    ...
    // Verify
    echo "\n--- VERIFIKASI ---\n";
    $stmt = mysqli_prepare($conn, "SELECT password FROM users WHERE email = 'admin@gmail.com'");
